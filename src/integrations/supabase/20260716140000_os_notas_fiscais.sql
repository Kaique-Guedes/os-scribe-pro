-- Permite múltiplas notas fiscais por O.S. (substitui os campos únicos valor_faturado_real/data_faturamento_real/numero_nota_fiscal)
...
COMMENT ON TABLE public.os_notas_fiscais IS 'Notas fiscais anexadas a uma O.S. Uma O.S. pode ter várias (faturamento parcial/múltiplo).';
